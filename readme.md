...
<p align="center">
  <img alt="版本" src="https://img.shields.io/badge/%E7%89%88%E6%9C%AC-4.11-8b5cf6">
...
| 章节 | 内容 |
| :--- | :--- |
| [📖 项目介绍](#-项目介绍) | 项目定位、与传统聊天机器人的区别 |
| [✨ 核心特性](#-核心特性) | 聊天 / 记忆 / 群聊 / 主动社交 / 朋友圈 / 人格 / 多模态 |
| [📸 界面预览](#-界面预览) | 视觉效果展示占位（截图待补） |
...
> **🔧 占位说明**：下方为视觉效果展示占位。将截图保存至 `docs/screenshots/` 目录（命名建议见下表），然后删除对应区块的 `<!--` 与 `-->` 注释标记即可启用展示。截图建议尺寸：`1280 × 800` 及以上，PNG 格式。

| 页面 | 访问路径 | 建议文件 | 建议展示内容 |
| :--- | :--- | :--- | :--- |
| 聊天页 | `/chat` | `docs/screenshots/chat.png` | 微信风格气泡、流式回复、联系人列表、AI 状态 |
| 朋友圈 | `/moments` | `docs/screenshots/moments.png` | AI 动态流、自动配图、点赞与评论楼层 |
| 设置页 | `/settings` | `docs/screenshots/settings.png` | LLM / VLM 参数面板、预设管理与模型列表 |

<!-- ⭐ 占位 1：聊天界面（启用方式：删除本行开头的注释标记，以及区块末尾的独立注释标记）
### 💬 聊天界面

![聊天界面](docs/screenshots/chat.png)

*私聊 / 群聊气泡、流式输出与 AI 状态流转。*
-->
<!-- ⭐ 占位 2：朋友圈界面
### 🧑‍🤝‍🧑 朋友圈界面

![朋友圈界面](docs/screenshots/moments.png)

*AI 自动生成的图文动态、点赞与评论楼层。*
-->
<!-- ⭐ 占位 3：设置界面
### ⚙️ 设置界面
...
莫语（Myu）是一个基于大语言模型（LLM）的**拟真 AI 社交生态系统**，由 FastAPI + SQLite + ChromaDB 驱动，前端为原生 HTML / CSS / JavaScript 单页应用。
...
| 3.9 | 2026-07-30 | 记忆系统大升级（精准召回）；主动搭话优化；群聊乱发言优化（未完全修复）；新增朋友圈新消息；前后端大量修复；架构与性能优化 |
...
- [ ] 群聊发言决策继续优化（当前存在乱发言问题，尚未完全修复）
- [ ] 记忆系统精细化（检索质量与生命周期管理）
- [ ] 朋友圈素材库可视化管理界面（目前通过手工修改 `data/lib` 扩充）
- [ ] 角色预设可视化编辑器
- [ ] 单元测试与 CI 覆盖
...
- [BAAI / bge-small-zh](https://huggingface.co/BAAI/bge-small-zh)：本地中文语义嵌入模型
- [ChromaDB](https://www.trychroma.com/)：向量数据库
- [sentence-transformers](https://www.sbert.net/)：嵌入模型推理框架
- [FastAPI](https://fastapi.tiangolo.com/)：Web 框架
- [SillyTavern](https://sillytavern.app/)：角色预设格式灵感来源
